...
export default function Sidebar({ links }: SidebarProps) {
  ...
  return (
    <>
      ...
      <button
        className="fixed bottom-5 left-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-brand-600 text-white shadow-lg transition-transform active:scale-95 md:hidden"
