...
const FAQ_RESPONSES: Record<string, string> = {
  ...
  pago: 'Aceptamos pagos manuales vía Zelle (USA), PIX (Brasil), SPEI (México) y tarjeta (Visa, MC, Amex) vía Square. Todos los pagos se coordinan por WhatsApp y un agente confirma en 2-4 horas.',
