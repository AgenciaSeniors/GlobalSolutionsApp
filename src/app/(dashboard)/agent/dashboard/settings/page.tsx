/**
 * @fileoverview Agent Settings — Profile management + account info.
 * Agent can update their name, phone, avatar and change password.
 * Agent code is read-only (assigned by admin).
 * @module app/(dashboard)/agent/dashboard/settings/page
 */
'use client';
        ...
        <div className="p-8 space-y-6 max-w-3xl">
          ...
          <Card variant="bordered">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-xl bg-neutral-50 p-4">
                ...
                <Badge variant="default">Gestor (Agent)</Badge>
              </div>
              <div className="rounded-xl bg-neutral-50 p-4">
                <p className="text-xs text-neutral-500 flex items-center gap-1 mb-1">
                  <Hash className="h-3 w-3" /> Código de gestor
                </p>
                <p className="font-mono font-bold text-brand-600 text-lg">{profile?.agent_code || 'Sin asignar'}</p>
              </div>
              <div className="rounded-xl bg-neutral-50 p-4">
                <p className="text-xs text-neutral-500 flex items-center gap-1 mb-1">
            ...
            {showPasswordForm ? (
              <form onSubmit={handleChangePassword} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button type="submit" isLoading={changingPassword} className="gap-2">
                    <Key className="h-4 w-4" /> Actualizar Contraseña
                  </Button>
                  <Button
                    variant="outline"
              ...
              <p className="text-sm text-neutral-500">
                Tu contraseña se puede cambiar en cualquier momento. Recomendamos usar al menos 8 caracteres
                con una combinación de letras, números y símbolos.
              </p>
            )}
          </Card>
          ...
          <Card variant="bordered" className="border-amber-200 bg-amber-50/30">
            <h3 className="text-sm font-bold text-amber-800 flex items-center gap-2 mb-2">
              <AlertCircle className="h-4 w-4" /> Reglas de la Plataforma
            </h3>
            <ul className="text-xs text-amber-700 space-y-1">
              <li>• Toda comunicación laboral debe realizarse dentro de esta plataforma.</li>
              <li>• El uso de WhatsApp para temas de trabajo <strong>está prohibido</strong>.</li>
              <li>• Las reservas deben gestionarse únicamente a través del sistema de tickets y reservas.</li>
              <li>• Tu código de gestor es asignado por el administrador y no puede ser modificado.</li>
            </ul>
          </Card>
        </div>
      </div>
