/**
 * @fileoverview Flight detail client component — interactive booking section.
 * Handles passenger selection, price calculation, and navigation to checkout.
 * Receives flight data as props from the server component.
 * @module app/(public)/flights/[id]/FlightDetailClient
 */
'use client';
...
/** Convert UTC timestamp to local airport time for display. */
...
export default function FlightDetailClient({ flight }: FlightDetailClientProps) {
  ...
  function handleBook() {
    ...
    router.push(`/checkout?flight=${flight.id}&passengers=${passengers}`);
  }
    ...
    <div className="mx-auto max-w-5xl px-6 py-8">
      ...
      <Card className="mb-6 bg-gradient-to-r from-brand-600 to-brand-800 text-white overflow-hidden">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="text-right">
            ...
            <p className="text-brand-200 text-sm">por persona (econ&oacute;mica)</p>
          </div>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card variant="bordered">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                <p className="text-3xl font-bold text-brand-900">{depTime}</p>
              ...
              {/* Arrival */}
              <div className="text-center">
                <p className="text-3xl font-bold text-brand-900">{arrTime}</p>
          ...
          <Card variant="bordered">
            <h2 className="font-bold text-lg mb-4 flex items-center gap-2">
              <Plane className="h-5 w-5 text-brand-500" /> Ficha T&eacute;cnica del Vuelo
            </h2>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="rounded-xl bg-neutral-50 p-3">
                <p className="text-xs font-semibold uppercase text-neutral-400 mb-1">Aerol&iacute;nea</p>
              ...
              <div className="rounded-xl bg-neutral-50 p-3">
                ...
                <p className="text-neutral-500">Modelo de avi&oacute;n</p>
              </div>
              <div className="rounded-xl bg-neutral-50 p-3">
                <p className="text-xs font-semibold uppercase text-neutral-400 mb-1">Duraci&oacute;n Total</p>
        ...
        <div className="space-y-4">
          <Card variant="bordered" className="sticky top-24">
            ...
            <div className="mt-3 flex items-center justify-center gap-1.5 text-xs text-neutral-400">
              <Shield className="h-3 w-3" /> Pago seguro &middot; PCI-DSS &middot; Datos encriptados
            </div>
          </Card>
        </div>
      </div>
